...
insert  into `vendedores`(`codigo_vendedor`,`sobrenome_vendedor`,`nome_vendedor`,`percentual_comissao`,`codigo_regiao`) values 
('01','Marcio','Vitor', 10,'01'),
('02','Gisele','Paes',15,'02'),
('03','Michele','Lima',12,'05'),
('04','Viviane','Araújo',9,'03'),
('05','Rafaela','Alves',8,'04'),
('06','Institucional','Acadêmico',1,'05'),
('07','Vinícius','Vieira', 5, '02');
